...
const blogSchema = { "@context": "https://schema.org", "@type": "Blog", "name": "RecordWatchdog Blog", "description": "Expert guides on navigating public records and the U.S. legal system.", "url": "https://www.recordwatchdog.com/blog/" };
...
blogPosts.forEach(post => {
  const blogSchema = {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://www.recordwatchdog.com/recordwatchdog-logo.png"
      }
    }
  };
